...
foreach ( $t_work_types as $t_work_type_code => $t_work_type_label ) {
	...
	$f_data[PLUGIN_PM_EST][$t_work_type_code] = time_to_minutes( gpc_get_string( 'change_' . PLUGIN_PM_EST . '_' . $t_work_type_code, null ) );
	$f_data[PLUGIN_PM_DONE][$t_work_type_code] = time_to_minutes( gpc_get_string( 'add_' . PLUGIN_PM_DONE . '_' . $t_work_type_code, null ) );
	$f_data[PLUGIN_PM_TODO][$t_work_type_code] = time_to_minutes( gpc_get_string( 'change_' . PLUGIN_PM_TODO . '_' . $t_work_type_code, null ) );
